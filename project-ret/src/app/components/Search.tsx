...
export default function Search() {
    ...
    const inputValueChangeHandler = (event: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    return (
        <div className="flex h-full items-end justify-center container relative mr-7">
            ...
            />
            <input 
                className="rounded-lg color-black h-10 w-full pl-12 bg-backgroundHeaderSearch"
                type="text"
                alt="Search"
                value={value}
                placeholder={"Search"}
